...
public class ChatClient3  extends UnicastRemoteObject implements ChatClient3IF {
	...
	private String hostName = "localhost";
        private String remoteHostName = "165.22.251.42";
	...
	public void startClient() throws RemoteException {		
		...
		try {
			Naming.rebind("rmi://" + hostName + "/" + clientServiceName, this);
                        ...
                        ChatServerIF stub = (ChatServerIF) registry.lookup("ChatServerIF");
                        serverIF = ( ChatServerIF )Naming.lookup("rmi://" + hostName + ":1099" + "/" + serviceName);	
		} 
